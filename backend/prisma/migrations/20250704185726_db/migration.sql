...
-- AddForeignKey
ALTER TABLE "producto" ADD CONSTRAINT "fk_producto_clasificacion" FOREIGN KEY ("idclasificacion") REFERENCES "clasificacion"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "pedido" ADD CONSTRAINT "fk_pedido_usuario" FOREIGN KEY ("usuarioid") REFERENCES "usuario"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "pedido_producto" ADD CONSTRAINT "fk_pedido_pedido_producto" FOREIGN KEY ("pedidoid") REFERENCES "pedido"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "pedido_producto" ADD CONSTRAINT "fk_producto_pedido_producto" FOREIGN KEY ("productoid") REFERENCES "producto"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
